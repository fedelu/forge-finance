    ...
    return (
      <div className="relative">
        ...
        <button
          ...
          className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-white px-4 py-2.5 rounded-xl transition-all duration-200 flex items-center space-x-3 group shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-600 backdrop-blur-sm"
        >
