      ...
      {!loading && !error && (
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <h2 className="text-3xl md:text-4xl font-inter-bold text-white mb-2 bg-gradient-to-r from-fogo-primary via-fogo-primary-light to-fogo-secondary bg-clip-text text-transparent">
              Available Crucibles
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            <div key={crucible.id} className="bg-gradient-to-br from-fogo-gray-900 via-fogo-gray-800 to-fogo-gray-900 rounded-3xl p-7 border border-fogo-gray-600/50 shadow-2xl hover:shadow-fogo-lg transition-all duration-500 hover:border-fogo-primary/60 hover:scale-[1.02] group backdrop-blur-sm relative overflow-hidden animate-fade-in">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 text-sm font-satoshi-light text-fogo-gray-200 mb-6">
                  <div className="flex justify-between items-center py-3.5 px-4 bg-fogo-gray-800/60 backdrop-blur-sm rounded-xl border border-fogo-gray-700/50 hover:border-fogo-primary/30 transition-all duration-300">
                    ...
                    <span className="font-inter-bold text-lg text-white">${crucible.tvl.toLocaleString()}</span>
                  </div>
                  {/* APY Display */}
                  <div className="space-y-2 py-3.5 px-4 bg-fogo-gray-800/60 backdrop-blur-sm rounded-xl border border-fogo-gray-700/50">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-fogo-primary via-fogo-primary-light to-fogo-primary hover:from-fogo-primary-dark hover:via-fogo-primary hover:to-fogo-primary-light text-white font-inter-bold py-4 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-fogo-lg group relative overflow-hidden border border-fogo-primary/20"
                  >
  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-orange-500/20 to-yellow-500/20 hover:from-orange-500/30 hover:to-yellow-500/30 border border-orange-500/30 hover:border-orange-500/50 text-orange-400 font-satoshi-bold py-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-orange-500/25 group relative overflow-hidden"
      >
...
function CrucibleCloseButton({
  ...
  return (
    <button
      ...
      className={`w-full py-4 rounded-xl font-inter-bold transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg flex items-center justify-center space-x-3 border relative overflow-hidden group ${
        !hasAnyPosition
  ...
  return (
    <div className="mt-6 pt-6 border-t border-orange-500/20">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-inter-bold text-white">My Leveraged Positions</h3>
