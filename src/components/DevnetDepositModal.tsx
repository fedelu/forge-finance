...
interface DevnetDepositModalProps {
  isOpen: boolean;
  onClose: () => void;
  crucibleId: string;
}

export const DevnetDepositModal: React.FC<DevnetDepositModalProps> = ({ isOpen, onClose, crucibleId }) => {
  ...
  const handleDeposit = async () => {
    ...
    try {
      console.log('Creating transaction for devnet...');
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-green-900/30 border border-green-600 rounded-lg">
            <p className="text-green-300 text-sm">
              ✅ <strong>Solana Devnet:</strong> This will send SOL to a test address on Solana devnet. 
