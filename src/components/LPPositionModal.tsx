    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md animate-fade-in">
      <div className="bg-gradient-to-br from-fogo-gray-900 via-fogo-gray-900 to-fogo-gray-800 rounded-3xl border border-fogo-gray-700/50 shadow-2xl w-full max-w-lg p-8 relative animate-scale-in">
          ...
          <div className="flex space-x-3">
            <div className="flex-1 relative">
              <input
                ...
                placeholder="0.00"
                className="w-full px-5 py-4 bg-fogo-gray-800/80 backdrop-blur-sm border-2 border-fogo-gray-700 rounded-xl text-white text-lg font-medium placeholder-fogo-gray-500 focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-500/20 transition-all duration-300"
              />
              {baseAmount && (
            ...
            <button
              ...
              className="px-6 py-4 bg-fogo-gray-700/80 hover:bg-green-500/20 border-2 border-fogo-gray-600 hover:border-green-500 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105"
            >
              MAX
            </button>
          </div>
        ...
        <div className="mb-5">
          ...
          <div className="text-xs text-fogo-gray-500 mt-2 flex items-center gap-1">
