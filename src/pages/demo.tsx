  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
      <div className="bg-gray-800 rounded-2xl p-8 max-w-md w-full border border-gray-700">
        ...
        <h3 className="text-xl font-bold text-white mb-4">Connect Your FOGO Wallet</h3>
        <p className="text-gray-300 mb-6">
          Connect your FOGO wallet to access all platform features including crucibles, governance, and analytics.
        </p>
        <button
          onClick={onConnect}
          className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center space-x-2"
        >
            ...
            <div className="space-y-8">
              ...
              <div className="card">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <button 
                    onClick={() => isEstablished ? setMainTab('crucibles') : connect()}
                  ...
                  >
                    ...
                    <p className="text-gray-400">{isEstablished ? 'Add liquidity to earn yield' : 'Connect wallet to access crucibles'}</p>
                  </button>
                  <button 
                    onClick={() => isEstablished ? setMainTab('analytics') : connect()}
                    className="p-6 bg-forge-gray rounded-lg border border-gray-700 hover:border-forge-primary transition-colors text-left"
                  >
                    ...
                    <p className="text-gray-400">{isEstablished ? 'Track your performance' : 'Connect wallet to view analytics'}</p>
                  </button>
                  <button 
                    onClick={() => isEstablished ? setMainTab('governance') : connect()}
                    className="p-6 bg-forge-gray rounded-lg border border-gray-700 hover:border-forge-primary transition-colors text-left"
                  >
                    <UserGroupIcon className="h-8 w-8 text-green-400 mb-4" />
                    <h3 className="text-lg font-semibold text-white mb-2">Governance</h3>
                    <p className="text-gray-400">{isEstablished ? 'Vote on proposals' : 'Connect wallet to participate in governance'}</p>
                  </button>
                </div>
              </div>
            </div>
