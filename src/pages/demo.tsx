...
import VolatilityFarmingMetrics from '../components/VolatilityFarmingMetrics'
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex items-center space-x-4">
                {/* Wallet Connection Button - Always visible on desktop */}
                {!isEstablished ? (
                  <button
                    onClick={connect}
                    className="hidden md:flex items-center space-x-3 bg-fogo-gray-800 hover:bg-fogo-gray-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 border border-fogo-gray-600 hover:border-fogo-primary/50"
                  >
