...
export default function DemoFixed() {
    ...
    <div className="space-y-8">
      ...
      <div className="card-glow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <button className="group p-8 bg-forge-gray-800/50 rounded-2xl border border-forge-gray-700/50 hover:border-forge-primary/30 transition-all duration-300 text-left hover-lift">
  ...
  return (
    <>
      <Head>
        <title>Forge Protocol - Demo Fixed</title>
        <meta name="description" content="Forge Protocol Demo Fixed - DeFi on Solana" />
