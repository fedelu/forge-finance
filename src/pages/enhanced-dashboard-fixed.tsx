...
export default function EnhancedDashboardFixed() {
  ...
  // Fixed data generation - deterministic to avoid hydration errors
  useEffect(() => {
    // Generate deterministic historical data using a fixed seed
    const generateHistoryData = (days: number, baseValue: number, volatility: number = 0.1, seed: number = 12345) => {
      const data = []
      const now = new Date()
    ...
    setAnalytics(prev => ({
      ...prev,
      yieldHistory: generateHistoryData(30, 1000, 0.15, 12345),
      priceHistory: {
        SOL: generateHistoryData(30, 100, 0.08, 54321),
        USDC: generateHistoryData(30, 1, 0.01, 98765),
        ETH: generateHistoryData(30, 2500, 0.12, 11111),
        BTC: generateHistoryData(30, 45000, 0.1, 22222)
      },
      volumeHistory: generateHistoryData(30, 50000, 0.2, 33333)
    }))
  }, [])
  ...
  return (
    <>
      <Head>
        <title>Forge Protocol - Enhanced Dashboard Fixed</title>
