...
interface WorkingRealModalProps {
  isOpen: boolean;
  onClose: () => void;
  crucibleId: string;
}

export const WorkingRealModal: React.FC<WorkingRealModalProps> = ({ isOpen, onClose, crucibleId }) => {
        ...
        <div className="space-y-4">
          ...
          <div className="p-3 bg-green-900/30 border border-green-600 rounded-lg">
            <p className="text-green-300 text-sm">
              ✅ <strong>Devnet:</strong> Using Solana devnet for testing. Your SOL will be deducted from your wallet.
            </p>
          </div>
